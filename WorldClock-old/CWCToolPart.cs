...
{
	class CWCToolPart : ToolPart, System.Web.UI.INamingContainer
	{
		...
		public CWCToolPart()
		{
			this.Init += new EventHandler(CWCToolPart_Init);
		...
		private void CWCToolPart_Init(object sender, EventArgs e)
		{
			...
			switch (e.CommandName)
			{
				...
				case "Save":
					if (this.editIndex == -1)
					{
						...
						tzOffset[this.timeZoneOffsets.Length] = this.timeZoneOffsets[n];
						tzName[this.timeZoneOffsets.Length] = this.timeZoneNames[n];
						tzDstAdj[this.timeZoneOffsets.Length] = this.timeDstAdjust[n];
						this.timeZoneOffsets = tzOffset;
						this.timeZoneNames = tzName;
						this.timeDstAdjust = tzDstAdj;
					}
